...
public abstract class GameCycle {
    ...
    public void onPlayerDies(Player player, Player killer) {
        ...
        game.getPlayerKill().put(killer, game.getPlayerKill().get(killer) + 1);
        game.getTeamKill().put(killerTeam.getName(), game.getTeamKill().get(killerTeam.getName()) + 1);
        game.updateScoreboardKill(killerTeam);
    ...
    private void runGameOver(Team winner) {
        ...
        this.getGame().getPlayerKill().clear();
        this.getGame().getTeamKill().clear();
